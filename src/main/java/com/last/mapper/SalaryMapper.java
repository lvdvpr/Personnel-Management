...
public interface SalaryMapper {
	...
	// 급여대상
	List<SalaryDto> getSalaryLists(String baseYearMonth);
	// 사원의 입력된 급여 정보 가져오기
	...
	// 급여삭제
	void deleteSalary(@Param("employeeNo") int employeeNo, @Param("baseYearMonth") String baseYearMonth);
	// 급여조회, 급여대장 
	...
	// 국민연금, 건강보험, 고용보험 납입내역
	List<SalaryContributionDto> getContributionDetails(Map<String, Object> param); 
